...
def raw_data_view(df):
    ...
    view_data = input("\nWould you like to see the raw data used to compute the statisticss? Type \'yes\' or \'no\'.\n:  ").lower()
    while True:
        ...
        if view_data == 'yes' or view_data =='y':
            print(df[k: k + 5])
            k += 5
        view_data = input("\n Would you like to see more rows of the raw data used to compute the statisticss? Type \'yes\' or \'no\'.\n:  ").lower()
